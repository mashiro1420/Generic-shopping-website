        ...
        <tbody>
            <?php
                ...
                echo '<tr>
                        ...
                        <td class="text-center">
								<a href="/WebBanHang/admin/quan_ly_nsx/sua_nsx.php?id='.$nha_san_xuat['ma_nha_san_xuat'].'"><i class="bi bi-pen-fill"></i></a> | 
								<a href="/WebBanHang/admin/quan_ly_nsx/xu_ly_xoa_nsx.php?id='.$nha_san_xuat['ma_nha_san_xuat'].'"><i class="bi bi-trash-fill"></i></a>
							</td>
                        </tr>';
                ?>
        </tbody>
