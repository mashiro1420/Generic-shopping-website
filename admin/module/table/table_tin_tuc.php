            ...
            <?php
                ...
                foreach($tin_tucs as $tin_tuc){
                    echo '<tr>
                        ...
                        <td class="text-center">
								<a href="/WebBanHang/admin/quan_ly_tin_tuc/sua_tin_tuc.php?id='.$tin_tuc['ma_tin_tuc'].'"><i class="bi bi-pen-fill"></i></a> | 
								<a href="/WebBanHang/admin/quan_ly_tin_tuc/xu_ly_xoa_tin_tuc.php?id='.$tin_tuc['ma_tin_tuc'].'"><i class="bi bi-trash-fill"></i></a>
							</td>
                    </tr>';
                }
