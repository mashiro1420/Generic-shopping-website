<div class="container-fluid">
    <div class="row" id="first-header">
        <div class="col-md-2 py-2 pl-3">
        <i class="bi bi-telephone-fill pr-1"></i> 0225.123.456
        </div>
        <div class="col-md-2 py-2 pl-3">
        <i class="bi bi-phone-fill pr-1"></i> 079.123.4567
        </div>
        <div class="col-md-2 py-2 pl-3">
        <i class="bi bi-envelope-fill pr-1"></i> website@gmail.com
        </div>
        <div class="col-md-6 py-2 px-3"> 
            <form action="/webbanhang/home/xu_ly_tim_kiem.php" method="POST" class="input-group-sm input-group">
                <input type="text" class="form-control my-0 mr-0" placeholder="Từ khóa" name="tu_khoa">
    ...
    <div class="row">
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item px-3"><a href="#" class="nav-link"><i class="bi bi-house-door-fill"></i> Trang chủ</a></li>
